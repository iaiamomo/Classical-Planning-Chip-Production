...
Boolean
State
Service_inv_no Service_inv_bo Service_inv_pe Service_inv_ru Service_des_us Service_inv_kz Service_inv_my Service_inv_us Service_inv_tr Service_inv_ar Service_inv_aus Service_inv_in Service_inv_fr Service_inv_sv Service_des_tw Service_des_ch Service_inv_ma Service_des_uk Service_inv_cl Service_inv_jp Service_inv_ca Service_inv_be Service_inv_au Service_inv_cn Service_inv_kr Service_inv_br - Service
)
(:predicates 
